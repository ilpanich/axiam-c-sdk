...
/*
 * One case per CONTRACT.md 27 operation -- all 158 of them. Each asserts that the operation
...
static void test_roles_list_users_reaches_its_route(void) {
    mgmt_mount(200, "[{\"inherit\": true, \"resource_id\": \"11111111-1111-4111-8111-111111111111\", \"tenant_scope\": [\"11111111-1111-4111-8111-111111111111\"], \"user\": {\"created_at\": \"2026-08-26T00:00:00Z\", \"email\": \"example\", \"email_verified\": true, \"failed_login_attempts\": 1, \"id\": \"11111111-1111-4111-8111-111111111111\", \"is_locked\": true, \"locked_until\": \"2026-08-26T00:00:00Z\", \"metadata\": {}, \"mfa_enabled\": true, \"status\": \"Active\", \"tenant_id\": \"11111111-1111-4111-8111-111111111111\", \"updated_at\": \"2026-08-26T00:00:00Z\", \"username\": \"example\"}}]");
    axiam_client_t *c = mgmt_signed_in_client();
    axiam_error_t err;
...
static void test_oauth2_clients_create_registration_token_reaches_its_route(void) {
    mgmt_mount(200, "{\"initial_access_token\": \"example\", \"token\": {\"created_at\": \"2026-08-26T00:00:00Z\", \"created_by\": \"11111111-1111-4111-8111-111111111111\", \"expires_at\": \"2026-08-26T00:00:00Z\", \"id\": \"11111111-1111-4111-8111-111111111111\", \"name\": \"example\", \"tenant_id\": \"11111111-1111-4111-8111-111111111111\", \"used_at\": \"2026-08-26T00:00:00Z\", \"used_by_client_id\": \"example\"}}");
    axiam_client_t *c = mgmt_signed_in_client();
    axiam_error_t err;
    axiam_mgmt_create_registration_token_request_t body;
    memset(&body, 0, sizeof(body));
    axiam_mgmt_create_registration_token_response_t *result = NULL;
    axiam_error_kind_t rc = axiam_oauth2_clients_create_registration_token(c, &body, &result, &err);

    TEST_ASSERT_EQUAL_INT(AXIAM_OK, rc);
    TEST_ASSERT_EQUAL_STRING("POST", mgmt_last_method());
    TEST_ASSERT_EQUAL_STRING("/api/v1/oauth2-clients/registration-tokens", mgmt_last_path());
    axiam_mgmt_create_registration_token_response_free(result);
    axiam_client_free(c);
}

static void test_oauth2_clients_create_registration_token_reaches_its_route_discards_the_result(void) {
    mgmt_mount(200, "{\"initial_access_token\": \"example\", \"token\": {\"created_at\": \"2026-08-26T00:00:00Z\", \"created_by\": \"11111111-1111-4111-8111-111111111111\", \"expires_at\": \"2026-08-26T00:00:00Z\", \"id\": \"11111111-1111-4111-8111-111111111111\", \"name\": \"example\", \"tenant_id\": \"11111111-1111-4111-8111-111111111111\", \"used_at\": \"2026-08-26T00:00:00Z\", \"used_by_client_id\": \"example\"}}");
    axiam_client_t *c = mgmt_signed_in_client();
    axiam_error_t err;
    axiam_mgmt_create_registration_token_request_t body;
    memset(&body, 0, sizeof(body));
    axiam_error_kind_t rc = axiam_oauth2_clients_create_registration_token(c, &body, NULL, &err);

    TEST_ASSERT_EQUAL_INT(AXIAM_OK, rc);
    axiam_client_free(c);
}

static void test_oauth2_clients_create_registration_token_reaches_its_route_rejects_a_wrong_shaped_body(void) {
    mgmt_mount(200, "[]");
    axiam_client_t *c = mgmt_signed_in_client();
    axiam_error_t err;
    axiam_mgmt_create_registration_token_request_t body;
...
static void test_oauth2_clients_list_registration_tokens_reaches_its_route(void) {
    mgmt_mount(200, "[{\"created_at\": \"2026-08-26T00:00:00Z\", \"created_by\": \"11111111-1111-4111-8111-111111111111\", \"expires_at\": \"2026-08-26T00:00:00Z\", \"id\": \"11111111-1111-4111-8111-111111111111\", \"name\": \"example\", \"tenant_id\": \"11111111-1111-4111-8111-111111111111\", \"used_at\": \"2026-08-26T00:00:00Z\", \"used_by_client_id\": \"example\"}]");
    axiam_client_t *c = mgmt_signed_in_client();
    axiam_error_t err;
    axiam_mgmt_registration_token_response_list_t *result = NULL;
    axiam_error_kind_t rc = axiam_oauth2_clients_list_registration_tokens(c, &result, &err);

    TEST_ASSERT_EQUAL_INT(AXIAM_OK, rc);
    TEST_ASSERT_EQUAL_STRING("GET", mgmt_last_method());
    TEST_ASSERT_EQUAL_STRING("/api/v1/oauth2-clients/registration-tokens", mgmt_last_path());
    axiam_mgmt_registration_token_response_list_free(result);
    axiam_client_free(c);
}

static void test_oauth2_clients_list_registration_tokens_reaches_its_route_discards_the_result(void) {
    mgmt_mount(200, "[{\"created_at\": \"2026-08-26T00:00:00Z\", \"created_by\": \"11111111-1111-4111-8111-111111111111\", \"expires_at\": \"2026-08-26T00:00:00Z\", \"id\": \"11111111-1111-4111-8111-111111111111\", \"name\": \"example\", \"tenant_id\": \"11111111-1111-4111-8111-111111111111\", \"used_at\": \"2026-08-26T00:00:00Z\", \"used_by_client_id\": \"example\"}]");
    axiam_client_t *c = mgmt_signed_in_client();
    axiam_error_t err;
    axiam_error_kind_t rc = axiam_oauth2_clients_list_registration_tokens(c, NULL, &err);
...
static void test_privacy_list_consents_reaches_its_route(void) {
    ...
    axiam_error_kind_t rc = axiam_privacy_list_consents(c, &result, &err);

    TEST_ASSERT_EQUAL_INT(AXIAM_OK, rc);
    TEST_ASSERT_EQUAL_STRING("GET", mgmt_last_method());
    TEST_ASSERT_EQUAL_STRING("/api/v1/account/consents", mgmt_last_path());
    axiam_mgmt_consent_view_list_free(result);
    axiam_client_free(c);
}

static void test_privacy_list_consents_reaches_its_route_discards_the_result(void) {
    mgmt_mount(200, "[{\"accepted_at\": \"2026-08-26T00:00:00Z\", \"consent_type\": \"example\", \"version\": \"example\", \"withdrawable\": true}]");
    axiam_client_t *c = mgmt_signed_in_client();
    axiam_error_t err;
    axiam_error_kind_t rc = axiam_privacy_list_consents(c, NULL, &err);

    TEST_ASSERT_EQUAL_INT(AXIAM_OK, rc);
    axiam_client_free(c);
}

static void test_privacy_grant_scope_consent_reaches_its_route(void) {
    mgmt_mount(204, NULL);
    axiam_client_t *c = mgmt_signed_in_client();
    axiam_error_t err;
    axiam_mgmt_grant_scope_consent_t body;
    memset(&body, 0, sizeof(body));
    axiam_error_kind_t rc = axiam_privacy_grant_scope_consent(c, &body, &err);

    TEST_ASSERT_EQUAL_INT(AXIAM_OK, rc);
    TEST_ASSERT_EQUAL_STRING("POST", mgmt_last_method());
    TEST_ASSERT_EQUAL_STRING("/api/v1/account/consents/oidc-scopes", mgmt_last_path());
    axiam_client_free(c);
}

static void test_privacy_withdraw_scope_consent_reaches_its_route(void) {
    mgmt_mount(204, NULL);
    axiam_client_t *c = mgmt_signed_in_client();
    axiam_error_t err;
    axiam_error_kind_t rc = axiam_privacy_withdraw_scope_consent(c, "11111111-1111-4111-8111-111111111111", &err);

    TEST_ASSERT_EQUAL_INT(AXIAM_OK, rc);
    TEST_ASSERT_EQUAL_STRING("DELETE", mgmt_last_method());
    TEST_ASSERT_EQUAL_STRING("/api/v1/account/consents/oidc-scopes/11111111-1111-4111-8111-111111111111", mgmt_last_path());
    axiam_client_free(c);
}
...
static void test_every_registry_operation_has_a_case(void) {
    TEST_ASSERT_EQUAL_INT(162, mgmt_case_count());
}
...
int main(void) {
    ...
    RUN_TEST(test_oauth2_clients_create_registration_token_reaches_its_route);
    RUN_TEST(test_oauth2_clients_list_registration_tokens_reaches_its_route);
    ...
    RUN_TEST(test_privacy_list_consents_reaches_its_route);
    RUN_TEST(test_privacy_grant_scope_consent_reaches_its_route);
    RUN_TEST(test_privacy_withdraw_scope_consent_reaches_its_route);
    ...
    RUN_TEST(test_oauth2_clients_create_registration_token_reaches_its_route_discards_the_result);
    RUN_TEST(test_oauth2_clients_create_registration_token_reaches_its_route_rejects_a_wrong_shaped_body);
    RUN_TEST(test_oauth2_clients_list_registration_tokens_reaches_its_route_discards_the_result);
    ...
    RUN_TEST(test_privacy_list_consents_reaches_its_route_discards_the_result);
...
int mgmt_case_count(void) { return 162; }
